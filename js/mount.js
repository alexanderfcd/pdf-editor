...
export class Editor extends CreateBase{
    ...
    GUIEditor(){
        ...
        this.guiEditor = new GUIEditor({
            ...
            if (this.activeNode()) {
                data.forEach(o => this.activeNode().style[o.prop || o.name] = o.value);

                this.activeNode().moveable.updateRect();

                let immediate =  this.activeNode().dataset.id !== this.stateManager.state.state()[0].id;
    ...
    events() {
        ...
        document.body.addEventListener('touchstart', this.handleMouseDown.bind(this))
