...
export class ScaleService extends CreateBase {
    ...
    scale(value) {
        ...
        const targets = this.instance.toolbar.node.ownerDocument.querySelectorAll('.section-content');
    ...
    fit ( e )  {
        let space = getComputedStyle(this.instance.toolbar.node).getPropertyValue('--toolbar-height');
